...
var states = {
    ...
    preload: function() {
    	this.preload = function() {
            ...
            game.load.audio('scoreMusic', 'http://24haowan-cdn.shanyougame.com/pickApple2/assets/audio/addscore.mp3');
            game.load.audio('bombMusic', 'http://24haowan-cdn.shanyougame.com/pickApple2/assets/audio/boom.mp3');
            // 添加进度文字
